/**
 * Look-away break messages — displayed during the LookAway reminder overlay.
 *
 * Each entry: { title: string, subtitle: string }
 *
 * Categories: eyes · hydration · stretching · coworker prompts ·
 *             distant friends · plants · personal hygiene · mental
 *             challenges · absurd/funny · mindful/reflective
 *
 * Add new entries freely — the overlay picks one at random per trigger.
 */
