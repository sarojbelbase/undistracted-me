...
const SpotifyMiniCard = ({ track, onToggle, onNext, onPrev, pending, skipPending, t }) => {
  // Detect track changes and animate the media info area.
  const prevTrackIdRef = useRef(track.title + track.artist);
  ...
  return (
    ...
    >
      {/* Album art + title + artist — fades in when track changes */}
