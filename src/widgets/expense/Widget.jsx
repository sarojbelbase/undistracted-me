...
import { WalletFill, PlusLg, XLg, CheckCircleFill, CashStack, ListUl } from 'react-bootstrap-icons';
import { BaseWidget } from '../BaseWidget';
import { useWidgetSettings } from '../useWidgetSettings';
import { useExpenses, DEFAULT_CATEGORIES, getCategoryInfo } from './useExpenses';
...
const PERIOD_LABELS = { week: 'This week spending', month: 'This month spending', year: 'This year spending' };

function budgetFromSettings(settings, timeRange) {
  if (timeRange === 'month') return settings.monthBudget;
  if (timeRange === 'year') return settings.yearBudget;
  return settings.weekBudget;
}
...
function AddExpenseModal({ currency, currencySymbol, onClose, onAdd }) {
...
export const Widget = ({ id, onRemove }) => {
  const [settings] = useWidgetSettings(id, {
    currency: 'USD',
    weekStartsOn: 'monday',
    timeRange: 'week',
    weekBudget: '',
  ...
  const settingsContent = useRef((onClose) => <ExpenseSettings id={id} onClose={onClose} />);
  settingsContent.current = (onClose) => <ExpenseSettings id={id} onClose={onClose} />;
  ...
  return (
    <>
      <BaseWidget
        ...
        onRemove={onRemove}
        settingsContent={settingsContent.current}
      ...
      >
        <div className="exp-card">
          ...
          <div ref={heroRef} className="exp-card__hero">
            ...
            <span className="exp-card__period">{PERIOD_LABELS[timeRange]}</span>
          </div>
