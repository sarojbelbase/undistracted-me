...
const App = () => {
  ...
  return (
    <div
      ...
      style={{ background: showWidgets ? '#F0F0F2' : '#18191B' }}
    >
      <div className="absolute top-5 right-5 z-50 flex gap-2">
        <button
          className={`p-2 rounded-full transition-all duration-300 focus:outline-none ${showWidgets ? 'hover:bg-black/10' : 'hover:bg-white/10'}`}
          onClick={toggleWidgets}
          title={showWidgets ? 'Hide Widgets' : 'Show Widgets'}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16" className={`transition-colors duration-300 ${showWidgets ? 'text-gray-500 hover:text-gray-900' : 'text-gray-300 hover:text-white'}`}>
        ...
        <button
          ...
          title='Settings'
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16" className={`hover:rotate-45 transition-transform duration-300 ${showWidgets ? 'text-gray-500 hover:text-gray-900' : 'text-gray-300 hover:text-white'}`}>
